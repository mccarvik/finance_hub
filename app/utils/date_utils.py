...
def dcc_calc(dcc, start, mid, end):
    if dcc == "ACT/ACT":
        delta_num = mid - start
        delta_den = end - start
        return (delta_num.days / delta_den.days)
    elif dcc == "ACT/360":
        delta_num = mid - start
        ...
        return (delta_num.days / delta_den)
    elif dcc == "30/360":
...
if __name__ == "__main__":
    ...
    print(dcc_calc("ACT/ACT", s, m, e)*4)
    print(dcc_calc("ACT/360", s, m, e)*4)
    print(dcc_calc("30/360", s, m, e)*4)